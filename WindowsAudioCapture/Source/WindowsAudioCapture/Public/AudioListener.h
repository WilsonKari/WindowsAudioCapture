...
private:
    ...
    IMMDevice* GetSpecificAudioDevice(const std::wstring& deviceName);
    IMMDevice* FindDeviceInCollection(IMMDeviceCollection* pDeviceCollection, const std::wstring& deviceName);
